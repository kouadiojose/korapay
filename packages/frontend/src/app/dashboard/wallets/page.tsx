...
const MOCK_WALLETS: WalletType[] = [
  { id: 'w1', currency: 'XOF', balance: 4850000, available_balance: 4500000, pending_balance: 350000 },
  { id: 'w2', currency: 'XAF', balance: 1200000, available_balance: 1200000, pending_balance: 0 },
  { id: 'w3', currency: 'NGN', balance: 750000, available_balance: 680000, pending_balance: 70000 },
];

const MOCK_WALLET_TRANSACTIONS: WalletTransaction[] = [
  { id: 'wt1', wallet_id: 'w1', type: 'credit', amount: 25000, balance_after: 4850000, reference: 'KP-TXN-2026-001', description: 'Paiement reçu - Amadou Koné', created_at: '2026-04-13T10:31:00Z' },
  { id: 'wt2', wallet_id: 'w1', type: 'credit', amount: 50000, balance_after: 4825000, reference: 'KP-TXN-2026-002', description: 'Paiement reçu - Fatou Diallo', created_at: '2026-04-13T09:16:00Z' },
  { id: 'wt3', wallet_id: 'w1', type: 'debit', amount: 100000, balance_after: 4775000, reference: 'KP-TXN-2026-004', description: 'Décaissement - Moussa Traoré', created_at: '2026-04-12T16:02:00Z' },
  { id: 'wt4', wallet_id: 'w1', type: 'credit', amount: 35000, balance_after: 4875000, reference: 'KP-TXN-2026-006', description: 'Paiement reçu - Jean Kouassi', created_at: '2026-04-12T11:21:00Z' },
  { id: 'wt5', wallet_id: 'w1', type: 'credit', amount: 120000, balance_after: 4840000, reference: 'KP-TXN-2026-007', description: 'Paiement reçu - Marie Coulibaly', created_at: '2026-04-11T15:46:00Z' },
  { id: 'wt6', wallet_id: 'w1', type: 'debit', amount: 200000, balance_after: 4720000, reference: 'KP-TXN-2026-008', description: 'Décaissement - Paul Yao', created_at: '2026-04-11T10:00:00Z' },
  { id: 'wt7', wallet_id: 'w1', type: 'credit', amount: 8500, balance_after: 4920000, reference: 'KP-TXN-2026-009', description: 'Paiement reçu - Awa Sanogo', created_at: '2026-04-10T09:31:00Z' },
  { id: 'wt8', wallet_id: 'w1', type: 'credit', amount: 450000, balance_after: 4911500, reference: 'KP-TXN-2026-010', description: 'Paiement reçu - Pierre Dubois', created_at: '2026-04-10T08:02:00Z' },
];
